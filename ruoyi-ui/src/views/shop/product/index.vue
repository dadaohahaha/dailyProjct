  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="活动时间" prop="activityTime">
        <el-select v-model="queryParams.activityTime" placeholder="请选择活动时间" clearable>
          <el-option
            v-for="dict in dict.type.activity_time"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-table v-loading="loading" :data="productList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="活动时间" align="center" prop="activityTime">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.activity_time" :value="scope.row.activityTime"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="活动时间" prop="activityTime">
          <el-select v-model="form.activityTime" placeholder="请选择活动时间">
            <el-option
              v-for="dict in dict.type.activity_time"
              :key="dict.value"
              :label="dict.label"
...
export default {
  name: "Product",
  dicts: ['product_category', 'activity_time', 'product_brand'],
  data() {
    return {
      // 遮罩层
      loading: true,
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除商品历史信息编号为"' + ids + '"的数据项？').then(function() {
